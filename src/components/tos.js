...
const Tos = () => {
    return (
        <div className={styles.container}>
            <h1>Terms of Use</h1>
            <p>
                <span class='num'>1</span>.<b>Introduction</b>
            </p>
            <p>
                Welcome to{' '}
                <b>
            ...
            <p>
                <span class='num'>2</span>. <b>Communications</b>
            </p>
            <p>
            ...
            <p>
                <span class='num'>4</span>. <b>Prohibited Uses</b>
            </p>
            <p>
            ...
            <p>
                <span class='num'>5</span>. <b>Analytics</b>
            </p>
            <p>
            ...
            <p>
                <span class='num'>6</span>. <b>No Use By Minors</b>
            </p>
            <p>
            ...
            <div id='account'></div>
            <p>
                <span class='num'>7</span>. <b>Intellectual Property</b>
            </p>
            <p>
                Service and its original content (excluding Content provided by
                users), features and functionality are and will remain the
                exclusive property of <span class='company-name'></span> and its
                licensors. Service is protected by copyright, trademark, and
                other laws of <span class='country'></span> and foreign
            ...
            <p>
                <span class='num'>8</span>. <b>Copyright Policy</b>
            </p>
            <p>
            ...
            <p>
                ...
                the laws of <span class='country-name'></span>, which governing
                law applies to agreement without regard to its conflict of law
                provisions.
            </p>
            <p>
